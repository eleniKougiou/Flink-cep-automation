...
# Terminal ./run.sh arg1 arg2 arg3 arg4 arg5 arg6 arg7
...
echo "(correct format: ./runpython.sh arg1 arg2 arg3 arg4 arg5 arg6 arg7) "
echo ""

if [ "$#" -ne 7 ]; then # Wrong number of parameters
...
# arg5 is not 1, 2, 3, 4 or 5
	...
	./runpython.sh $1 $2 $3 $4 $6
	echo "RUN FLINK PROGRAM"
	./runflink.sh 0 $1 $4 $5 $6 $7
fi
